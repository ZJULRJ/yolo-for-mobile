...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgpath', type=str, default=r'E:\automation\yolo\sample\newimg (32).jpg', help="image path")
    parser.add_argument('--modelpath', type=str, default=r'E:\automation\yolo\weights\best (1).onnx', help="onnx filepath")
    parser.add_argument('--classfile', type=str, default='my.names', help="classname filepath")
